        ...
        <div class="content-adm">
            <form method="POST" action="" id="form-edit-home-prem-img" class="form-adm" enctype="multipart/form-data">
                ...
                <div class="row-input">
                    ...
                    <div class="column">
                        <?php
                        if ((!empty($valorForm['image'])) and (file_exists("app/sts/assets/image/about/" . $valorForm['id'] . "/" . $valorForm['image']))) {
                            $old_image = URLADM . "app/sts/assets/image/about/" . $valorForm['id'] . "/" . $valorForm['image'];
                        } else {
                            $old_image = URLADM . "app/sts/assets/image/about/icon_about_comp.jpg";
                        }
                        ?>
                        <span id="preview-img">
                ...
                <button type="submit" name="SendEditAboutsCompImage" class="btn-warning" value="Salvar">Salvar</button>
