...
class AdmsPagination
{
    ...
    private function layoutPagination(): void
    {
        ...
        // $this->page = 3 / Página que o usuário que acessar
        // $this->maxLinks = 2 / Quantidade de páginas que podem ter antes e depois da página escolhida se for = 2 exibe (4)(5)<{6}>(7)(8)
        // $this->beforepage =  1 -> 2 -> 3 página que o usuário que acessar menos 
        ...
        // $this->page = 3 / Página que o usuário que acessar
        // $this->maxLinks = 2 / Quantidade de páginas que podem ter antes e depois da página escolhida se for = 2 exibe (4)(5)<{6}>(7)(8)
        // $this->afterPage =  4 -> 5 -> 6 página que o usuário que acessar menos 
        // $this->totalPages = 5 Quantidade de páginas que podem ser retornadas
